...
p_graphique_comparaison_parc_recent_dpe_ges<-graphique_comparaison_parc_recent(indicateur="DPE GES classe A,B ou C",title="Logements sociaux avec un DPE GES de classe A,B ou C",caption=caption)
