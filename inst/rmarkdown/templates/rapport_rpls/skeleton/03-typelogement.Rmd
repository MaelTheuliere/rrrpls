...
p_comparaison_parc_recent_type_logement<-graphique_comparaison_parc_recent(indicateur="Logements collectifs",titre="Logements sociaux collectifs",caption=caption)
