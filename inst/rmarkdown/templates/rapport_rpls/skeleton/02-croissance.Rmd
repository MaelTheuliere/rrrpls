...
p_croissance<-carte_indic_croissance(zoom_reg = T) + carte_indic_croissance(zoom_reg = F) + plot_layout(ncol = 2,widths = c(3,2))
p_croissance
```
...
df %>% 
  ...
  labs(x="",y="",title="Poids du parc récent dans l'ensemble du parc social",caption=caption)
```
