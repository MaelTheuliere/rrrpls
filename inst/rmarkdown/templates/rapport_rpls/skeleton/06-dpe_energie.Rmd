...
p_graphique_comparaison_parc_recent_dpe_energie<-graphique_comparaison_parc_recent(indicateur="DPE énergie classe A,B ou C",title="Part des logements sociaux avec un DPE énergie de classe A,B ou C",caption=caption)
