...
composeur_carte(indicateur="En QPV",
...
p4<-graphique_comparaison_parc_recent(indicateur="En QPV",titre="Part des logements sociaux en QPV",caption=caption)
p4
```

```{r fig.width=12,fig.height = 8}
graph_repartition_par_date(indicateur=qpv_red,
