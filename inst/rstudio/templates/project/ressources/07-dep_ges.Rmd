...
composeur_carte(indicateur="DPE GES classe A,B ou C",
...
p_graphique_comparaison_parc_recent_dpe_ges<-graphique_comparaison_parc_recent(indicateur="DPE GES classe A,B ou C",titre="Part des logements sociaux avec un DPE GES de classe A,B ou C",caption=caption)
p_graphique_comparaison_parc_recent_dpe_ges
```

```{r fig.width=12,fig.height = 8}
graph_repartition_par_date(indicateur=dpeserre_red,
